...
types:
  ...
  parameter:
    ...
    instances:
      show_at_zero:
        value: show_at_zero_u1 != 0
      is_active:
        value: is_active_u1 != 0
      is_player_money:
        value: is_player_money_u1 != 0
  ...
  parameter_action:
    ...
    instances:
      percent_present:
        value: percent_present_u1 != 0
      expr_present:
        value: delta_present_u1 != 0
      delta_present:
        value: delta_present_u1 != 0
      param:
        value: _root.parameters[idx]
    enums:
      show_mode:
        0: no_change
        1: show
  ...
  location:
    ...
    types:
      type:
        ...
        instances:
          is_initial:
            value: '(_root.format_version < 6 ? (is_initial_u1 != 0) : (type_u1 == type::initial))'
          is_success:
            value: '(_root.format_version < 6 ? (is_success_u1 != 0) : (type_u1 == type::success))'
          is_fail:
            value: '(_root.format_version < 6 ? (is_fail_u1 != 0) : (type_u1 == type::fail)) or is_death'
          is_death:
            value: '(_root.format_version < 6 ? (is_death_u1 != 0) : (type_u1 == type::death))'
          is_empty:
            value: '(_root.format_version < 6 ? (is_empty_u1 != 0) : (type_u1 == type::empty))'
        enums:
          type:
            0: none
            1: initial
